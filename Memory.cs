...
namespace CNLibrary
{
    ...
    public struct Memory
    {
        ...
        /// <param name="useHack">Use a "hack" for fixing overlapping issues</param>
        public void write_string(string address, string write, bool useHack = true)
        {
            ...
            if (useHack) Array.Resize(ref bytes, write.Length * 2);
