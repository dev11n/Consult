...
namespace CNLibrary
{
    public struct Utils
    {
        ...
        internal static void cache_modules(string processName)
        {
            ...
            win64 = Internals.IsWow64Process(theProc.Handle, out win64);
        ...
        {
            // Checks if win64 is true, then automatically redirects to the x64 get_real_address function if it is.
            if (win64) return get_real_address_64(code);
